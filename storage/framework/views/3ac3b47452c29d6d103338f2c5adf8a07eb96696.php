...
<head>
  ...
  <style>
    ...
    .color {
      ...
      border: 4px solid rgb(35, 155, 86);
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item text-center mx-2 mx-lg-1">
                  <a class="nav-link active" aria-current="page" href="<?php echo e(url('/index')); ?>">
                    <div>
                ...
                <li class="nav-item text-center mx-2 mx-lg-1">
                  <a class="nav-link" aria-current="page" href="<?php echo e(url('/fullcalender')); ?>">
                    <div>
  ...
  <div class="container p-4 pb-0">
    ...
    <section class="mb-4">
      ...
      <a class="btn btn-outline-light btn-floating m-1" href="#!" role="button"
        ><i class="fa fa-facebook" aria-hidden="true"></i></i></a>
...
</html><?php /**PATH C:\xampp\htdocs\Proyecto\herbario\resources\views/layouts/plantillabase0.blade.php ENDPATH**/ ?>