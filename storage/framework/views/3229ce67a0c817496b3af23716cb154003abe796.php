                    ...
                    <div class="col-10">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                ...
                                <?php } ?>
                                <li class="nav-item text-center mx-2 mx-lg-1">
                                    <a class="nav-link active" aria-current="page" href="<?php echo e(url('/map')); ?>">
                                        <div>
...
</html><?php /**PATH C:\xampp\htdocs\Proyecto\herbario\resources\views/layouts/plantillabase2.blade.php ENDPATH**/ ?>